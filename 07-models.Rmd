...
model1<-lm(ft_Trump~as.numeric(partyid), weight=weight, data=anes2024)
model2<-lm(ft_Trump~as.numeric(ideology), weight=weight, data=anes2024)
library(stargazer)
...
model3<-lm(ft_Trump~as.numeric(partyid)+as.numeric(ideology), weight=weight, data=anes2024)
...
model5<-lm(ft_Trump~as.numeric(partyid)+as.numeric(ideology)+education+income+female+minority, weight=weight, data=anes2024)

---
title: "<span style='color:darkblue;font-weight:bold;font-size: 50px'>APPLIED STATISTICS<br>FOR POLITICAL SCIENCE<br>Chapter 7</style>"
output:
...
```{r table2, echo=FALSE, comment="", warning=FALSE, error=FALSE}
...
# Verify these....and figure out why adjusted r-squared is flawed.
...
beta6<- model5$coefficients[6] * sd(model5$model[,7]) / sd(model5$model[,1])
``` 
<br>

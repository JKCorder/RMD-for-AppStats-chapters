---
title: "<span style='color:darkblue;font-weight:bold;font-size: 50px'>APPLIED STATISTICS<br>FOR POLITICAL SCIENCE<br>Chapter 6</style>"
output:
...
```{r figure1, echo=FALSE, out.width = '80%'}
...
```{r figure3, echo=FALSE, out.width = '80%'}
...
```{r figure64, warning=FALSE, message=FALSE, echo=FALSE}

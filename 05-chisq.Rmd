...
# This is the interim combined sample post-election weight
...
table51<-100*prop.table(wtd.table(x=anes2024$ideology, w=anes2024$weight))
...
table52<-100*prop.table(wtd.table(anes2024$female, anes2024$ideology, anes2024$weight), margin=1)
kable(table52, digits=1)
test1<-chisq.test(wtd.table(anes2024$female, anes2024$ideology, anes2024$weight))
...
```{r table55, echo=FALSE, out.width = '90%'}
...
test1<-chisq.test(0.10*wtd.table(anes2024$female, anes2024$ideology, anes2024$weight))
cat("n=", round(sum(test1$expected),0), "Chi-square =", test1$statistic, ", p =", sprintf("%.3f",round(test1$p.value, 3)), ", df =", test1$parameter)
